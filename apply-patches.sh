...
SOURCE_DIR=$PWD
PHH=${SOURCE_DIR}/patches/PHH
Andy=${SOURCE_DIR}/patches/Andy
extra=${SOURCE_DIR}/patches/extra
...
#vendor_arrow
DISPLAY_MSG=1
cp -r ${Andy}/vendor_arrow ${SOURCE_DIR}/vendor/arrow/andy && cd ${SOURCE_DIR}/vendor/arrow
for i in {0001..0001}
do apply_patches vendor/arrow andy $i
done
...
#vendor/arrow
DISPLAY_MSG=1
cp -r ${extra}/vendor_arrow ${SOURCE_DIR}/vendor/arrow/extra && cd ${SOURCE_DIR}/vendor/arrow
for i in {0001..0001}
do apply_patches vendor/arrow extra $i
done
